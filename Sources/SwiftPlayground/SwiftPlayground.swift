...
func gameMenu() -> Int {
    ...
    guard let userInput = readLine(), let UserInput2 = Int(userInput),
        UserInput2 >= menuLowerBoundary, UserInput2 <= menuUpperBoundary
    else {
...
func createGameState() {
    ...
    print(
        "As you wake up from your night of drinking and slowly rise from your bed you start to look around the room you hazily remember walking into last night with the tavern keeper Paul."
    )
    ...
    var userChoice = 0
        ...
        if userChoice == 3 {
            ...
            if userChoice == 4 {
                print(
                    "You look under the bed and all you can see in the darkness under there is a rubber ducky."
                )
            }
            if userChoice == 5 {
                print(
                    "As you walk down the stairs outside your rooms door you smell the thick scent of beef stew and fresh bread and see Paul the barkeeper pouring the drinks and his maids walk around the tavern delivering meals and asking if people want second breakfast"
                )
                print("")
